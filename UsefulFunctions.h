...
string saveFilename(const  char *filter = "All Files (output.ppm)\0*.*\0", HWND owner = NULL);
string openfilename(const  char *filter = "All Files (output.ppm)\0*.*\0", HWND owner = NULL);
